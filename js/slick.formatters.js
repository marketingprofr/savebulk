...
(function ($) {
  ...
  function CheckmarkFormatter(row, cell, value, columnDef, dataContext) {
   ...
   function ProductUrlFormatter(row, cell, value, columnDef, dataContext)
   {
		...
		{
			if(columnDef.id === '_post_permalink')
			{
				if(dataContext['_post_permalink'] !== undefined && dataContext['_post_permalink'] !== "")
       			return "<a href='" + dataContext['_post_permalink'] + "' target='_blank'>" + dataContext['_post_permalink'] + "</a>";
			}else
			{
